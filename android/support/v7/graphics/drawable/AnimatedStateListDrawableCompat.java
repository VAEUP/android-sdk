...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    public static android.support.v7.graphics.drawable.AnimatedStateListDrawableCompat create(@android.support.annotation.NonNull android.content.Context r7, @android.support.annotation.DrawableRes int r8, @android.support.annotation.Nullable android.content.res.Resources.Theme r9) {
        /*
            r6 = 2
        ...
        L_0x0029:
            return r5
        L_0x002a:
            android.support.v7.graphics.drawable.AnimatedStateListDrawableCompat r5 = createFromXmlInner(r7, r3, r2, r0, r9)     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x002f }
            goto L_0x0029
        L_0x002f:
            r1 = move-exception
            java.lang.String r5 = LOGTAG
